...
big_font = pygame.font.Font(f'assets/font/myfont.ttf', 60)
WIDTH = 900
HEIGHT = 800
...
for i in range(1, 4):
    ...
    if i < 3:
        ...
        for j in range(1, 5):
            target_images[i - 1].append(pygame.transform.scale(pygame.image.load(f'assets/targets/{i}/{j}.png'), (120 - (j * 10), 80 - (j * 12))))
...
pygame.mixer.init()
pygame.mixer.music.load('assets/sounds/suvi.mp3')
pygame.mixer.music.set_volume(.2)
plate_sound = pygame.mixer.Sound('assets/sounds/arnold.mp3')
plate_sound.set_volume(10)
bird_sound = pygame.mixer.Sound('assets/sounds/pibunn.mp3')
bird_sound.set_volume(10)
laser_sound = pygame.mixer.Sound('assets/sounds/bruno.mp3')
laser_sound.set_volume(10)
...
while run:
    ...
    # Creating a way to get out of the infinite while-loop
